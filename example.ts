...
type StaffAccount = [number, string, string, string?, string?];
...
const payStubs: PayStubs[] = [
  [staff[0], 250],
  [staff[1], 250, 260],
  [staff[2], 300, 300, 300, 400],
];

const monthOnePayments = payStubs[0][1] + payStubs[1][1] + payStubs[2][1];
const monthTwoPayments = payStubs[1][2] + payStubs[2][2];
const monthThreePayments = payStubs[2][3];
const monthfourPayments = payStubs[2][4];
...
calculatePayForEmployee(staff[2][0], payStubs[2][1], payStubs[2][2], payStubs[2][3], payStubs[2][4]);
